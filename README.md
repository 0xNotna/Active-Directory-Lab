...
Designed a network topology to visualize data flow and improve organization for more efficient troubleshooting.

<img width="601" height="480" alt="image" src="https://github.com/user-attachments/assets/dfe2be43-e88c-4f01-921e-c008c5dead82" />

## *2: Installation and Virtual Machine Setup*

Configured appropiately to machine specifications + Nat Network to route internally 
